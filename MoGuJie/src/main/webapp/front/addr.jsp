...
<div id="full">
	...
	<div id="dzgl"><p>地址管理</p></div>
    	...
    	<div id="dizhi">
    		<form name='myform'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	省：<span id="xing">*</span> <select id="province"><option id="sheng"></option></select>
    &nbsp;&nbsp;市：<select id="city"><option id="shi">--请选择城市--</option><option id="myshi" style="display:none;"></option></select>
     &nbsp;&nbsp;区：<select id="area"><option id="qu">--请选择地区--</option><option id="myqu" style="display:none;"></option></select>
</form>
      <br/>
    
     &nbsp;&nbsp;&nbsp;邮政编码：<span id="xing">*</span> <input type="text" id="youbian1" name="youbian" onBlur="checkYoubian1()" style="width:135px;height:25px">&nbsp;&nbsp;&nbsp;<span id="ybts1"></span>
     	<br/><br/>
      &nbsp;&nbsp;&nbsp;<span id="jiedao">街道地址：</span>
      <span id="xing1">*</span> <input type="text"   id="street1" onBlur="checkStreet1()" style="width:590px;height:70px"/>&nbsp;&nbsp;&nbsp;<span id="jdts1"></span><br/>
      <span id="shuoming">请填写街道地址，最少5个字，最多不能超过100个字</span>
      	<br/><br/>
       收货人姓名：<span id="xing">*</span> <input type="text"  id="uname1" onBlur="checkName1()" style="width:135px;height:25px">&nbsp;&nbsp;&nbsp;<span id="xmts1"></span>
       	<br/><br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手机：<span id="xing">*</span> <input type="text"  id="tel1" onBlur="checkTel1()" style="width:135px;height:25px"/>&nbsp;&nbsp;&nbsp;<span id="dhts1"></span>
        <br/><br/>
